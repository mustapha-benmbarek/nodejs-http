# Node.js : HTTP server <img valign="bottom" align="right" height="40px" widht="40px" src="https://nodejs.org/static/images/logos/nodejs-new-pantone-black.png" />
...
### How to make it run
```
git clone https://github.com/mustapha-benmbarek/nodejs-http
cd nodejs-http
npm install
node index.js
```
